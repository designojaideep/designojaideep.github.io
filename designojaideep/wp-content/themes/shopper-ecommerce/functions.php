...
function shopper_ecommerce_customize( $wp_customize ) {
	...
	$volunteer = get_theme_mod('shopper_ecommerce_featured_cat_increament');
...
define('SHOPPER_ECOMMERCE_PRO_LINK',__('https://www.ovationthemes.com/wordpress/shopper-wordpress-theme/','shopper-ecommerce'));
