...
<main id="content">
        ...
        <div class="services-box my-5 my-lg-0">
          <div class="row">
            <?php
              ...
              $page_query = new WP_Query(array( 'category_name' => esc_html($services_category ,'shopper-ecommerce')));?>
  ...
  <section id="featured-cat" class="py-5 text-center">
    <div class="container">
      ...
      <?php }?>
      <div class="row mt-5">
        <?php $featured_cat = get_theme_mod('shopper_ecommerce_featured_cat_increament');
        for ($i=1; $i <= $featured_cat; $i++) { ?>
          <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="box mb-4">
              <?php if( get_theme_mod('shopper_ecommerce_featured_cat_box_image'.$i) != '' ){ ?>
                <img src="<?php echo esc_url(get_theme_mod('shopper_ecommerce_featured_cat_box_image'.$i)); ?>">
              <?php }?>
